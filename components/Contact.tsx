        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className=" md:w-1/2 ">
            <h1 className="justify-center text-center text-2xl font-bold mb-6 md:text-left">
              Whether you&apos;re interested in <span className="font-bold text-red-500">working with me</span>, or just want to <span className="font-bold text-red-500">learn more</span> I&apos;d love to hear from you!
              <hr className="w-8 h-1 mx-auto my-4 bg-gradient-to-r from-red-400 to-pink-600 border-0 rounded"></hr>
            </h1>
            ...
            <p className="text-center">
              ...
              <br></br>
              I also have some social media links at the bottom of the page.
            </p>
          </div>
